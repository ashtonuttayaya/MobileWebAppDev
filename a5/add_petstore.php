					...
					<h2>Pet Stores</h2>
						...
						<form id="add_petstore" method="post" class="form-horizontal" action="add_petstore_process.php">
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="30" class="form-control" name="name" placeholder="(max 30 characters)"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="30" class="form-control" name="street" placeholder="(max 30 characters)"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="30" class="form-control" name="city" placeholder="(max 30 characters)"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="9" class="form-control" name="zip" placeholder="(5 or 9 digits no dashes)"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="10" class="form-control" name="phone" placeholder="(10 digits no other characters)"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="100" class="form-control" name="email" placeholder="example@gmail.com" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="100" class="form-control" name="url" placeholder="example.url.org"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="11" class="form-control" name="ytd_sales" placeholder="Example: 100.00 (no other characters)"/>
										</div>
								</div>
