						...
						<form id="edit_petstore" method="post" class="form-horizontal" action="edit_petstore_process.php">
							<?php 
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="30" class="form-control" name="name" placeholder="(max 30 characters)" value="<?php echo $result['pst_name']; ?>"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="30" class="form-control" name="street" placeholder="(max 30 characters)" value="<?php echo $result['pst_street']; ?>"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="30" class="form-control" name="city" placeholder="(max 30 characters)" value="<?php echo $result['pst_city']; ?>"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="9" class="form-control" name="zip" placeholder="(5 or 9 digits no dashes)" value="<?php echo $result['pst_zip']; ?>"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="10" class="form-control" name="phone" placeholder="(10 digits no other characters)" value="<?php echo $result['pst_phone']; ?>"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="100" class="form-control" name="email" placeholder="example@gmail.com" value="<?php echo $result['pst_email']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="100" class="form-control" name="url" placeholder="example.url.org" value="<?php echo $result['pst_url']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" maxlength="11" class="form-control" name="ytd_sales" placeholder="Example: 100.00 (no other characters)" value="<?php echo $result['pst_ytd_sales']; ?>" />
										</div>
								</div>
					...
					email: {
							validators: {
									...
									stringLength: {
											min: 1,
											max: 100,
											message: 'Email no more that 100 characters'
									},
									regexp: {
					...
					url: {
							validators: {
									...
									stringLength: {
											min: 1,
											max: 100,
											message: 'URL no more than 10 characters'
									},
									regexp: {
										
										regexp: /^(https?:\/\/)?([da-z\.-]+)\.([a-z\.]{2,6})([\/\w\.-]*)*\/?$/,		
									message: 'URL can only contain letters, numbers, commas, hyphens, or periods'
									},									
							},
					},
					...
					ytd_sales: {
							validators: {
									...
									stringLength: {
											min: 1,
											max: 11,
											message: 'YTD Sales may not be longer 10 digits, including decimal point'
									},
									regexp: {
