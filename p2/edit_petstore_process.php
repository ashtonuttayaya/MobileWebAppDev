...
else if (!is_numeric($pst_ytd_sales_v) || $pst_ytd_sales_v <= 0)
{
    ...
    $error = 'Street can only contain letters, numbers, hyphens, commas, and periods.';
    include('../global/error.php');
}
    ...
    $error = 'City can only contain letters, numbers, and a space character.';
    include('../global/error.php');
}
    ...
    $error = 'YTD Sales must contain no more than 10 digits inluding a decimal point.';
    include('../global/error.php');
}
